    ...
    <SidebarProvider>
      ...
      <div className="min-h-screen flex w-full bg-[#FAFAF9] inter">
        <Sidebar className="border-r-0 sidebar-custom">
          <SidebarHeader className="bg-[#6E0000] p-6 flex flex-col gap-2 border-b border-white/10">
            <div className="gap- gap- items-s items-st items-sta items-star items-star items-sta items-st items-s items- items-w items-wr items-wra items-wrap items-wra items-wr items-w items- items-f items- items-s items- items-e items-en items-en items-e items- items-c items-ce items-cen items-cent items-cente gap- flex items-center gap-3 w-[230px]">
              <div className="w-12 h-12 bg-white rounded-lg flex items-center justify-center overflow-hidden">
                <img
                  ...
                  alt="R Feitosa Group" className="bg-[#6E0000] w-full h-full object-contain" />
              ...
              <SidebarGroupContent>
                <SidebarMenu className="space-y-2">
                  ...
                  <SidebarMenuItem key={item.title}>
                      <SidebarMenuButton
                      asChild
                      className={`text-white hover:bg-white/20 transition-all duration-200 rounded-xl py-3 px-4 ${
          ...
          <SidebarFooter className="bg-[#6E0000] p-6 flex flex-col gap-2 border-t border-white/10">
            <div className="flex items-center gap-3 text-white/80">
              <div className="w-10 h-10 bg-white/20 rounded-full flex items-center justify-center">
                <Scale className="w-5 h-5 text-white" />
              </div>
              <div className="flex-1 min-w-0">
                <p className="font-semibold text-white text-sm">Advocacia Digital</p>
                <p className="text-xs text-white/60">Petições Inteligentes</p>
              </div>
            </div>
          </SidebarFooter>
        </Sidebar>
        ...
        <main className="flex-1 flex flex-col">
          <header className="bg-white border-b border-gray-200 px-6 py-4 md:hidden shadow-sm">
            <div className="flex items-center gap-4">
              ...
              <h1 className="text-xl font-semibold merriweather">Agente de Petição</h1>
            </div>
          </header>
